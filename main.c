...
#define MY_DNS_IP_ADDR 0x72727272 // 114.114.114.114
...
static esp_err_t event_handler(void *ctx, system_event_t *event)
{
  ...
  case SYSTEM_EVENT_STA_GOT_IP:
    ESP_LOGI(TAG, "本机ip:" IPSTR, IP2STR(&event->event_info.got_ip.ip_info.ip));
    s_retry_num = 0;
...
void wifi_init_sta()
{
    ...
    ESP_LOGI(TAG, "域名解析地址:" IPSTR, IP2STR(&dnsserver.u_addr.ip4));
